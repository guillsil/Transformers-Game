...
const Transformers TRANSFORMER_OPTIMUS_PRIME("Optimus Prime",80,100,70,"Autobots","Camion");
const Transformers TRANSFORMER_MEGATRON("Megatron",80,90,100,"Decepticons","Avion");
const size_t POSICION_PERSONAJE_PRINCIPAL = 0;
const size_t CANTIDAD_VERTICES_POR_NIVEL = 4;
